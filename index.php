...
if (isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])) {
    ...
    echo '<button style="background-color: black; color:white; height:50px; padding:10px; border-radius:10px;" type="button" data-toggle="modal" data-target="#authModal">Log In / Register</button>';
}
?>
            </li>
        </ul>
